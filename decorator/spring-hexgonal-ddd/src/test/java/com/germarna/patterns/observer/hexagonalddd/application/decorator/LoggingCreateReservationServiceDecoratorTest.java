...
public class LoggingCreateReservationServiceDecoratorTest {
	@Mock
	private CreateReservationUseCase delegate;

	@Test
	void createReservation_logsMessage() {
		final LoggingCreateReservationServiceDecorator decorator = new LoggingCreateReservationServiceDecorator(
				this.delegate);
